{{-- Botón INICIO --}}
<a href="{{ route('home') }}" class="nav-neon-link px-2 {{ request()->routeIs('home') ? 'text-green-400 active' : 'text-gray-300 hover:text-white' }}">
    <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/></svg>
    Inicio
</a>

{{-- Botón CAMPEONATOS --}}
<a href="{{ route('arena.index') }}" class="nav-neon-link px-2 {{ request()->routeIs('arena.*') ? 'text-green-400 active' : 'text-gray-300 hover:text-white' }}">
...
{{-- Botón MAPA --}}
<a href="{{ route('mapa.index') }}" class="nav-neon-link px-2 {{ request()->routeIs('mapa.index') ? 'text-green-400 active' : 'text-gray-300 hover:text-white' }}">
...
@auth
    {{-- Botón MIS RESERVAS --}}
    <a href="{{ route('reservas.user.index') }}" class="nav-neon-link px-2 {{ request()->routeIs('reservas.user.*') ? 'text-green-400 active' : 'text-gray-300 hover:text-white' }}">
