...
>
    <style>
        ...
        .btn-pill-3d {
            ...
            box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.3), inset 0 1px 0 rgba(255, 255, 255, 0.2);
        }
    ...
    <nav class="flex justify-between h-20 items-center w-full">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden lg:hidden bg-[#0f172a] border-t border-gray-700 -mx-4 sm:-mx-6 lg:-mx-[34px]">
