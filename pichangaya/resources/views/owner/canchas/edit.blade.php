    ...
    <main class="py-12 bg-gray-50 min-h-screen">
        <section class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <article class="bg-white overflow-hidden shadow-xl sm:rounded-2xl border border-gray-100">
                ...
                {{-- Cabecera visual --}}
                <header class="bg-indigo-50/50 px-6 py-4 border-b border-indigo-100 flex justify-between items-center">
                    <hgroup>
                ...
                <form action="{{ route('owner.canchas.update', $cancha) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <fieldset class="p-8 border-b border-gray-100">
                        <legend class="sr-only">Información Principal</legend>
                    ...
                    <fieldset class="p-8 border-b border-gray-100">
                        <header class="mb-4">
                            ...
                            <section class="flex items-center gap-2">
                                ...
                                <span class="text-sm text-gray-500">Modifica los deportes si es necesario.</span>
                            </section>
                        </header>
                    ...
                    <fieldset class="p-8 border-b border-gray-100">
                        <legend class="block text-lg font-bold text-gray-900 mb-4">Galería de Fotos</legend>
                            ...
                            <section class="mb-4">
                                ...
                                <div class="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-5 gap-4">
                                    @foreach($cancha->getMedia('canchas') as $media)
                                        <figure class="relative group rounded-xl overflow-hidden shadow-sm border border-gray-200 block">
                                            ...
                                            <label class="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex flex-col items-center justify-center cursor-pointer">
                                                ...
                                                <span class="bg-white text-red-600 rounded-full p-2 shadow-lg mb-2 peer-checked:bg-red-600 peer-checked:text-white transition-colors block">
                                            ...
                                            <span class="absolute top-2 right-2 hidden peer-checked:block w-3 h-3 bg-red-500 rounded-full"></span>
                                        </figure>
                                    @endforeach
                                </div>
                            </section>
                            ...
                            <div class="flex items-center justify-center w-full">
                                <label for="images" class="flex flex-col items-center justify-center w-full h-32 border-2 border-indigo-300 border-dashed rounded-xl cursor-pointer bg-white hover:bg-indigo-50 transition-colors">
                                    <figure class="flex flex-col items-center justify-center pt-5 pb-6">
                                        ...
                                        <figcaption class="mb-2 text-sm text-indigo-600"><span class="font-bold">Click para subir</span></figcaption>
                                    </figure>
...
<script>
    ...
    // --- VISTA PREVIA DE IMÁGENES NUEVAS (Usando <figure>) ---
