...
<body class="font-sans antialiased text-gray-900 bg-gray-50 dark:bg-gray-950 dark:text-gray-100">
    ...
    <div class="relative bg-gray-900 text-white overflow-hidden">
        ...
        {{-- 2. CARRUSEL DESTACADOS (Dentro de la zona oscura) --}}
        @if(isset($featuredCanchas) && $featuredCanchas->isNotEmpty() && !request('search'))
            <div class="relative pb-28 z-10">
        ...
        {{-- 🌊 LA OLA: Posicionada al fondo de la sección oscura (debajo del carrusel) --}}
    ...
    {{-- 3. LISTADO DE CANCHAS (Con etiquetas de servicios recuperadas) --}}
                ...
                @foreach($canchas as $cancha)
                    <article class="bg-white dark:bg-gray-800 rounded-2xl shadow-md overflow-hidden hover:shadow-2xl transition-all duration-300 border border-gray-100 dark:border-gray-700 flex flex-col h-full group">
                        ...
                        <div class="p-5 flex-grow flex flex-col">
                            ...
                            {{-- Etiquetas de Distrito y Deporte --}}
                            ...
                            {{-- ETIQUETAS DE SERVICIOS (RECUPERADAS) --}}
    ...
    {{-- 4. SECCIÓN ¿QUIÉNES SOMOS? (REDISEÑADA CON IMAGEN) --}}
    <section class="py-20 bg-white dark:bg-gray-900 border-t border-gray-100 dark:border-gray-800 overflow-hidden">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    {{-- FOOTER (CON ICONO DE CORREO Y ATENCIÓN INMEDIATA) --}}
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
                <div class="space-y-4">
                    ...
                    {{-- REDES SOCIALES E ICONO DE CORREO (RECUPERADO) --}}
                ...
                <div>
                    ...
                    <ul class="space-y-4 text-sm font-medium">
                        ...
                        {{-- BOTÓN DE ATENCIÓN INMEDIATA (RECUPERADO) --}}
