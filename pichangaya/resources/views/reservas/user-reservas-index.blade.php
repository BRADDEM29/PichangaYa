            ...
            <div class="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl shadow-2xl sm:rounded-2xl border border-gray-200 dark:border-gray-700 overflow-hidden">
                ...
                @if ($reservas->isEmpty())
                    ...
                    <div class="flex flex-col items-center justify-center py-20 px-4 text-center">
                        <div class="w-24 h-24 bg-gray-100 dark:bg-gray-700 rounded-full flex items-center justify-center mb-6 animate-pulse">
                        ...
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                            <thead class="bg-gray-50/50 dark:bg-gray-900/30">
                                <tr>
                                    ...
                                    {{-- NUEVA COLUMNA DE FECHA DE SOLICITUD --}}
                            ...
                            <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                @foreach ($reservas as $reserva)
                                    ...
                                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors group">
                                        ...
                                        {{-- NUEVA COLUMNA: SOLICITADO EL (Created At) --}}
                                        <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <div class="flex items-center justify-end space-x-3">
                                                ...
                                                @if(!$canEdit && !$canCancel)
                                                     <span class="text-gray-300 dark:text-gray-600 cursor-not-allowed px-2" title="No disponible">
                    ...
                    <div class="md:hidden grid grid-cols-1 gap-4 p-4 bg-gray-50 dark:bg-black/20">
                        @foreach ($reservas as $reserva)
                            @php
                                // PHP PARA MOVIL
                                $statusConfig = [
                                    'pending'      => ['label' => 'Pendiente',       'color' => 'bg-gray-100 text-gray-700 border-gray-200 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-600', 'side' => 'bg-gray-400'],
                                    'confirmed'    => ['label' => 'Confirmada',      'color' => 'bg-blue-100 text-blue-700 border-blue-200 dark:bg-blue-900/30 dark:text-blue-300 dark:border-blue-800', 'side' => 'bg-blue-500'],
                                    'advance_paid' => ['label' => 'Seña Pagada',     'color' => 'bg-amber-100 text-amber-700 border-amber-200 dark:bg-amber-900/30 dark:text-amber-300 dark:border-amber-800', 'side' => 'bg-amber-500'],
                                    'fully_paid'   => ['label' => 'Pagado',          'color' => 'bg-emerald-100 text-emerald-700 border-emerald-200 dark:bg-emerald-900/30 dark:text-emerald-300 dark:border-emerald-800', 'side' => 'bg-emerald-500'],
                                    'cancelled'    => ['label' => 'Cancelada',       'color' => 'bg-red-100 text-red-700 border-red-200 dark:bg-red-900/30 dark:text-red-300 dark:border-red-800', 'side' => 'bg-red-500'],
                                ];
                            ...
                            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md border border-gray-100 dark:border-gray-700 p-5 relative overflow-hidden">
                                ...
                                <div class="flex items-center text-xs text-gray-400 dark:text-gray-500 mb-4 pl-2 border-t border-gray-100 dark:border-gray-700 pt-2 border-dashed">
                                    ...
                                    Solicitado el {{ $reserva->created_at->format('d/m/Y h:i A') }}
                                </div>
